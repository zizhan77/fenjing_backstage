  ...
  methods: {
    ...
    autoadd(){
      console.log( this.activity)
          this.$service.post(API.getChangeCode, {activityId: this.activity}).then(res => {
                  console.log("自动生成优惠券",res)
                  this.queryTableList();
                });
    },
    ...
    queryTableList(){
      this.$service.post(API.prizeQueryAll, { activityId: this.activity }).then(res => {
